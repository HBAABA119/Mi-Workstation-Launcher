    ...
    WidgetGlass(modifier = modifier, hazeState = hazeState) {
        Column(modifier = Modifier.fillMaxWidth().padding(16.dp), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
            Row(verticalAlignment = Alignment.Bottom, horizontalArrangement = Arrangement.Center) {
                ...
                Text(text = ":", fontSize = 40.sp, fontWeight = FontWeight.Thin, color = AccentBlue, modifier = Modifier.padding(horizontal = 2.dp))
                Text(text = minute, fontSize = 48.sp, fontWeight = FontWeight.Thin, color = TextPrimary, letterSpacing = (-2).sp)
            }
            Spacer(modifier = Modifier.height(4.dp))
            Text(text = dateStr, fontSize = 12.sp, fontWeight = FontWeight.Normal, color = TextSecondary)
        }
    }
}
